...
namespace Aplicatie_Web.Models
{
    public class GameCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Aplicatie_WebContext context, Game game)
        {
        ...
        public void UpdateGameCategories(Aplicatie_WebContext context, string[] selectedCategories, Game gameToUpdate)
        {
            ...
            foreach (var cat in context.Category)
            {
                if (selectedCategoriesHS.Contains(cat.ID.ToString()))
                {
                    ...
                    {
                        gameToUpdate.GameCategories.Add(new GameCategory
                        {
